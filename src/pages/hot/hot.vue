		...
		<view class="search-box">
			<view class="input-box">
				<input type="text" :adjust-position="true" :placeholder="defaultKeyword" @input="inputChange"
					v-model="keyword" placeholder-class="placeholder-class" confirm-type="search">
			</view>
			...
			<scroll-view class="keyword-box" scroll-y>
				...
				<view class="keyword-block">
					<view class="keyword-list-header">
						<view>热门搜索</view>
						<view>
							<image style="right: 25upx;" @tap="hotToggle"
								:src="'/static/HM-search/attention'+forbid+'.png'"></image>
						</view>
					</view>
